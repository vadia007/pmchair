			...
			<fieldset class="panelform">
				<ul class="adminformlist">
					...
					<?php echo $this->form->getInput('created_by'); ?></li>
			                ...
			                <li><?php echo $this->form->getLabel('so_created_by'); ?>
			                <?php echo $this->form->getInput('so_created_by'); ?>
			                  <input type="submit" name="clear" value=" Видалити співавтора "onclick="
			                      document.forms[0].elements[14].value = '';
			                      document.forms[0].elements['jform[so_created_by]'].value = 0;
                        		return false;"></li>
