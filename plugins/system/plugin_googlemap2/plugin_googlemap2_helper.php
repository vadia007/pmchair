...
//		}
	...
	function _processMapv3_template() {
		...
		if ($this->_mp->align!='none')
			$code.="<div class='map' id='mapbody".$this->_mp->mapnm."' style=\"display: none; text-align:".$this->_mp->align."\">";
		else
			$code.="<div id='mapbody".$this->_mp->mapnm." class='map'"."' style=\"display: none;\">";
