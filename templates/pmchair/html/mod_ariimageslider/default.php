...
?>
<div class="nivo-shadow-rel">
<div class="nivo-shadow"></div>
</div>
    <div class="slider_gradient">
        <div class="slider_bg">
            <div class="container_12">
<div id="<?php echo $sliderId; ?>_wrapper " class="slider_wrapper grid_12 ari-image-slider-wrapper ari-is-theme-<?php echo $theme; ?><?php if ($cssClass):?> <?php echo $cssClass; ?><?php endif; ?><?php if ($controlNav):?> ari-image-slider-wCtrlNav<?php endif; ?>">
	<div id="<?php echo $sliderId; ?>" class="ari-image-slider slider">
	<?php
	$slideIdx = 0;
