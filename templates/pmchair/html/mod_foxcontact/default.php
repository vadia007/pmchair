...
<?php if($_SERVER['REQUEST_URI'] == '/kontakty.html'):?>
...
if (!empty($page_subheading))
	echo("<h2><a href ='/kontakty.html'>" . $page_subheading . "</a></h2>" . PHP_EOL);
?>
...
<form enctype="multipart/form-data" onsubmit="return validates();" class="foxform" action="<?php echo($link); ?>" method="post">
